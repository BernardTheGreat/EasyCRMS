...
<?php echo $this->Form->create('ProviderMachine'); ?>
	<fieldset>
		<legend><?php echo __('Edit Provider Machine'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProviderMachine.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ProviderMachine.id')))); ?></li>
