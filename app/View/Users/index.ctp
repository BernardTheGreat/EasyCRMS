<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('employee_type'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['suffix']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['position']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['employee_type']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['entry_datetime']); ?>&nbsp;</td>
